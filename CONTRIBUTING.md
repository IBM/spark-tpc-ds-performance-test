...
repository](https://github.com/IBM/spark-tpc-ds-performance-test).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBM/spark-tpc-ds-performance-test/issues). Before embarking on
...
issue](https://github.com/IBM/spark-tpc-ds-performance-test/issues) before sending a pull
...
Please feel free to connect with us: [here](https://github.com/IBM/spark-tpc-ds-performance-test/issues)
